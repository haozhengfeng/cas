...
import org.haozf.oauth2.core.infrastructure.jdbc.OauthCodeRowMapper;
...
public class OauthJdbcRepository extends AbstractJdbcRepository implements OauthRepository {
    ...
    public ClientDetails findClientDetails(String clientId) {
        ...
        final List<ClientDetails> list = jdbc.query(sql, clientDetailsRowMapper, clientId);
    ...
    public OauthCode findOauthCode(String code, String clientId) {
        ...
        final List<OauthCode> list = jdbc.query(sql, oauthCodeRowMapper, code, clientId);
        return list.isEmpty() ? null : list.get(0);
    }
    ...
    public OauthCode findOauthCodeByUsernameClientId(String username, String clientId) {
        ...
        final List<OauthCode> list = jdbc.query(sql, oauthCodeRowMapper, username, clientId);
        return list.isEmpty() ? null : list.get(0);
    }
    ...
    public AccessToken findAccessToken(String clientId, String username, String authenticationId) {
        ...
        final List<AccessToken> list = jdbc.query(sql, accessTokenRowMapper, clientId, username, authenticationId);
        return list.isEmpty() ? null : list.get(0);
    }
    ...
    public AccessToken findAccessTokenByRefreshToken(String refreshToken, String clientId) {
        ...
        final List<AccessToken> list = jdbc.query(sql, accessTokenRowMapper, refreshToken, clientId);
        return list.isEmpty() ? null : list.get(0);
    }
    ...
    public List<ClientDetails> findClientDetailsListByClientId(String clientId) {
        ...
        if (StringUtils.isNotEmpty(clientId)) {
            ...
            return jdbc.query(sql, clientDetailsRowMapper, clientId);
        }
        sql += " order by create_time desc  ";
        return jdbc.query(sql, clientDetailsRowMapper);
    }
